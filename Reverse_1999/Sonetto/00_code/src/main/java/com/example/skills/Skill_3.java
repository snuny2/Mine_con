...
public class Skill_3 {
    ...
    public static void fire(Player player, CustomSkillPlugin plugin) {
        player.playSound(player.getLocation(),
                Sound.ENTITY_ARROW_SHOOT, 1f, 0.8f);
        ...
        ArmorStand stand = player.getWorld()
                .spawn(start, ArmorStand.class, as -> {
                    ...
                    meta.setCustomModelData(CustomSkillPlugin.PROJECTILE_MODEL_DATA);
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                // 꼬리 파티클 - CRIT_MAGIC → ENCHANTED_HIT
